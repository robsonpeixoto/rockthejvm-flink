...
/** A package describing data types and generator functions for shopping cart events. We analyze a
  * variety of scenarios in the course, and these generators were built for this purpose.
  */
